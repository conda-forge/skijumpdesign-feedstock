About skijumpdesign-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/skijumpdesign-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4598&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/skijumpdesign-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `skijumpdesign` can be installed with `conda`:
...
```
mamba install skijumpdesign
```

It is possible to list all of the versions of `skijumpdesign` available on your platform with `conda`:
...
```
mamba search skijumpdesign --channel conda-forge
```
...
mamba repoquery search skijumpdesign --channel conda-forge

# List packages depending on `skijumpdesign`:
mamba repoquery whoneeds skijumpdesign --channel conda-forge

# List dependencies of `skijumpdesign`:
mamba repoquery depends skijumpdesign --channel conda-forge
```
